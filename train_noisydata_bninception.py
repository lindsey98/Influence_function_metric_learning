...
parser.add_argument('--config', default='config/cub_ProxyNCA_prob_orig_bninception.json')
...
parser.add_argument('--loss-type', default='cub_noisy_0.1', type=str)
...
if __name__ == '__main__':
    ...
    dataset_config = utils.load_config('dataset/config_bninception.json')
    ...
    for e in range(0, args.nb_epochs):
        ...
        if e == args.nb_epochs-1:
            save_dir = 'models/dvi_data_{}_{}_loss{}/BnInception_{}_Model'.format(args.dataset, args.seed,
