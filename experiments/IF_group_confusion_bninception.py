...
if __name__ == '__main__':
    ...
    IS = OrigIF(dataset_name, seed, loss_type, config_name, data_transform_config, test_crop, sz_embedding, epoch, model_arch)
    base_dir = "Influential_data_baselines_BnInception"
    ...
    for pair_idx, pair in enumerate(confusion_class_pairs):
        ...
        if os.path.exists("{}/{}_{}_helpful_testcls{}.npy".format(base_dir, IS.dataset_name, IS.loss_type, pair_idx)):
            print('skip')
            continue
        ...
        np.save("{}/{}_{}_helpful_testcls{}".format(base_dir, IS.dataset_name, IS.loss_type, pair_idx),
                helpful_indices)
        np.save("{}/{}_{}_harmful_testcls{}".format(base_dir, IS.dataset_name, IS.loss_type, pair_idx),
                harmful_indices)
    #
    ...
    for pair_idx, class_pair in enumerate(confusion_class_pairs):
        ...
        weight_path = 'models/dvi_data_{}_{}_loss{}_2_0/ResNet_512_Model/Epoch_1/{}_{}_trainval_{}_{}.pth'.format(
                          dataset_name, seed,
                          '{}_confusion_{}_baseline_BnInception'.format(loss_type, wrong_cls),
        ...
        os.system("python train_sample_reweight_bninception.py \
                --dataset {} \
                --loss-type {}_confusion_{}_baseline_BnInception \
