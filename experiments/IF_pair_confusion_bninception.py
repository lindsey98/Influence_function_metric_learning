...
if __name__ == '__main__':
    ...
    sz_embedding = 512; epoch = 40; test_crop = False; data_transform_config = 'dataset/config_bninception.json'; model_arch = 'BnInception'
    ...
    base_dir = 'Confuse_pair_influential_data_baselines_BnInception/{}'.format(IS.dataset_name)
    ...
    for kk in tqdm(range(min(len(wrong_indices), 100))):
        ...
        new_weight_path = 'models/dvi_data_{}_{}_loss{}_2_0/ResNet_512_Model/Epoch_1/{}_{}_trainval_{}_{}.pth'.format(
            dataset_name, seed,
            '{}_confusion_{}_{}_Allsamples_baseline_BnInception'.format(loss_type, wrong_ind, confuse_ind),
        ...
        os.system("python train_sample_reweight_bninception.py --dataset {} \
                        --loss-type {}_confusion_{}_{}_Allsamples_baseline_BnInception \
    ...
    result_log_file = 'Confuse_pair_influential_data_BnInception/{}_{}_pairs_baseline.txt'.format(IS.dataset_name, loss_type)
