...
--loss-type ProxyNCA_pfix_confusion_103_threshold50_40epochs \
...
python train_sample_reweight.py --dataset cars \
--loss-type ProxyNCA_pfix_confusion_139_threshold50_40epochs \
...
python train_sample_reweight.py --dataset cars \
--loss-type ProxyNCA_pfix_confusion_182_threshold50_40epochs \
...
python train_sample_reweight.py --dataset cars \
--loss-type ProxyNCA_pfix_confusion_163_threshold50_40epochs \
...
python train_sample_reweight.py --dataset cars \
--loss-type ProxyNCA_pfix_confusion_106_threshold50_40epochs \
...
python train_sample_reweight.py --dataset cars \
--loss-type ProxyNCA_pfix_confusion_166_threshold50_40epochs \
