...
--harmful Influential_data/cars_ProxyNCA_prob_orig_harmful_testcls1.npy --model_dir models/dvi_data_cars_3_lossProxyNCA_prob_orig/ResNet_512_Model \
--helpful_weight 0 --harmful_weight 2 \
--seed 3 --config config/cars_reweight.json
...
--harmful Influential_data/cars_ProxyNCA_prob_orig_harmful_testcls2.npy --model_dir models/dvi_data_cars_3_lossProxyNCA_prob_orig/ResNet_512_Model \
--helpful_weight 0 --harmful_weight 2 \
--seed 3 --config config/cars_reweight.json
...
--harmful Influential_data/cars_ProxyNCA_prob_orig_harmful_testcls3.npy --model_dir models/dvi_data_cars_3_lossProxyNCA_prob_orig/ResNet_512_Model \
--helpful_weight 0 --harmful_weight 2 \
--seed 3 --config config/cars_reweight.json
...
--harmful Influential_data/cars_ProxyNCA_prob_orig_harmful_testcls5.npy --model_dir models/dvi_data_cars_3_lossProxyNCA_prob_orig/ResNet_512_Model \
--helpful_weight 0 --harmful_weight 2 \
--seed 3 --config config/cars_reweight.json
...
--harmful Influential_data/cars_ProxyNCA_prob_orig_harmful_testcls6.npy --model_dir models/dvi_data_cars_3_lossProxyNCA_prob_orig/ResNet_512_Model \
--helpful_weight 0 --harmful_weight 2 \
--seed 3 --config config/cars_reweight.json
...
--harmful Influential_data/cars_ProxyNCA_prob_orig_harmful_testcls7.npy --model_dir models/dvi_data_cars_3_lossProxyNCA_prob_orig/ResNet_512_Model \
--helpful_weight 0 --harmful_weight 2 \
--seed 3 --config config/cars_reweight.json
...
--harmful Influential_data/cars_ProxyNCA_prob_orig_harmful_testcls8.npy --model_dir models/dvi_data_cars_3_lossProxyNCA_prob_orig/ResNet_512_Model \
--helpful_weight 0 --harmful_weight 2 \
--seed 3 --config config/cars_reweight.json
