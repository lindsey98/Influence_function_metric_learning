...
parser.add_argument('--mode', default='trainval', choices=['trainval', 'test',
                                                           'testontrain'],
...
parser.add_argument('--data_root', default = '/home/ruofan/PycharmProjects/SoftTriple/datasets/cub2011',
                    type=str)
...
if __name__ == '__main__':
    ...
    out_results_fn = "log/%s_%s_%s_%d_%d_loss%s_mixed.json" % (args.dataset, curr_fn, args.mode,args.sz_embedding,
                                                                        args.seed,
                                                                        args.loss_type)

    args.log_filename = '%s_%s_%s_%d_%d_loss%s_mixed' % (args.dataset, curr_fn, args.mode,
                                                         args.sz_embedding,
                                                         args.seed,
                                                         args.loss_type)
    ...
    if args.mode == 'trainval':
        train_results_fn = "log/%s_%s_%s_%d_%d_loss%s_mixed.json" % (args.dataset, curr_fn, args.mode,args.sz_embedding,
                                                                    args.seed,
                                                                    args.loss_type)
    ...
    for e in range(0, args.nb_epochs):
        ...
        if e % 10 == 0:
            save_dir = 'dvi_data_{}_loss{}_mixed/ResNet_{}_Model'.format(args.dataset,
                                                                         args.loss_type,
