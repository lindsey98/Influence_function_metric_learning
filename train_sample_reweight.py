...
parser.add_argument('--loss-type', default='ProxyNCA_pfix_confusion_sample500_143_179_reverse', type=str)
parser.add_argument('--helpful', default='Influential_data/{}_{}_harmful_testcls{}.npy'.format('cars', 'ProxyNCA_pfix', '3'), type=str)
parser.add_argument('--harmful', default='Influential_data/{}_{}_helpful_testcls{}.npy'.format('cars', 'ProxyNCA_pfix', '3'), type=str)
