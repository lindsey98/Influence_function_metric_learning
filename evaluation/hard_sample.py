...
if __name__ == '__main__':
    log_filename = 'cars49_cars49_pfix_trainval_512_0_lossProxyNCA_pfix'
    ...
    np.save(os.path.join('hard_samples_ind',
                         'cars49_ProxyNCA_pfix_easy_fit.npy'), top_easy2fit)
    np.save(os.path.join('hard_samples_ind',
                         'cars49_ProxyNCA_pfix_hard_fit.npy'), top_hard2fit)