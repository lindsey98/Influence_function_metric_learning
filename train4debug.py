...
if __name__ == '__main__':
    ...
    num_cls_per_batch = 8
    sz_embedding = 2048
    config = utils.load_config('config/vggface.json')
    ...
    tr_dataset = dataset.load(
        name='vgg',
        root=dataset_config['dataset']['vgg']['root'],
        source=dataset_config['dataset']['vgg']['source'],
        classes=dataset_config['dataset']['vgg']['classes']['trainval'],
    ...
    ev_dataset =  dataset.load(
            ...
            root=dataset_config['dataset']['vgg']['root'],
            source=dataset_config['dataset']['vgg']['source'],
            classes=dataset_config['dataset']['vgg']['classes']['eval'],
