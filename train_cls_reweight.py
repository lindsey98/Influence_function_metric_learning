...
parser.add_argument('--loss-type', default='ProxyNCA_prob_orig_intravar_102', type=str)
parser.add_argument('--helpful', default=[37], nargs='+', type=int)
parser.add_argument('--harmful', default=[31, 36], nargs='+', type=int)
