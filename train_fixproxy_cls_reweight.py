...
parser.add_argument('--config', default='config/cub_anchor_pfix_reweight.json')
...
parser.add_argument('--loss-type', default='ProxyAnchor_pfix_intravar_102_NN', type=str)
parser.add_argument('--helpful', default=[21], nargs='+', type=int)
parser.add_argument('--harmful', default=[36, 38], nargs='+', type=int)
