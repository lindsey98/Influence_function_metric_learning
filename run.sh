...
--loss-type ProxyNCA_pfix_confusion_143_threshold50_40epochs \
...
python train_sample_reweight.py --dataset cub \
--loss-type ProxyNCA_pfix_confusion_117_threshold50_40epochs \
...
python train_sample_reweight.py --dataset cub \
--loss-type ProxyNCA_pfix_confusion_178_threshold50_40epochs \
...
python train_sample_reweight.py --dataset cub \
--loss-type ProxyNCA_pfix_confusion_111_threshold50_40epochs \
...
python train_sample_reweight.py --dataset cub \
--loss-type ProxyNCA_pfix_confusion_126_threshold50_40epochs \
...
python train_sample_reweight.py --dataset cub \
--loss-type ProxyNCA_pfix_confusion_128_threshold50_40epochs \
...
python train_sample_reweight.py --dataset cub \
--loss-type ProxyNCA_pfix_confusion_124_threshold50_40epochs \
...
python train_sample_reweight.py --dataset cub \
--loss-type ProxyNCA_pfix_confusion_196_threshold50_40epochs \
...
python train_sample_reweight.py --dataset cub \
--loss-type ProxyNCA_pfix_confusion_142_threshold50_40epochs \
...
python train_sample_reweight.py --dataset cub \
--loss-type ProxyNCA_pfix_confusion_195_threshold50_40epochs \
