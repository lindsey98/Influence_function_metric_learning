python train_sample_reweight.py --loss-type ProxyNCA_pfix_confusion_103_threshold50_10epochs \
...
--dataset cars --seed 4 --config config/cars_reweight.json

python train_sample_reweight.py --loss-type ProxyNCA_pfix_confusion_163_threshold50_10epochs \
...
python train_sample_reweight.py --loss-type ProxyNCA_pfix_confusion_166_threshold50_10epochs \
...
python train_sample_reweight.py --loss-type ProxyNCA_pfix_confusion_143_threshold50_10epochs \
...
python train_sample_reweight.py --loss-type ProxyNCA_pfix_confusion_183_threshold50_10epochs \
...
python train_sample_reweight.py --loss-type ProxyNCA_pfix_confusion_128_threshold50_10epochs \
...
python train_sample_reweight.py --loss-type ProxyNCA_pfix_confusion_111_threshold50_10epochs \
...
python train_sample_reweight.py --loss-type ProxyNCA_pfix_confusion_179_threshold50_10epochs \
...
python train_sample_reweight.py --loss-type ProxyNCA_pfix_confusion_180_threshold50_10epochs \
...
python train_sample_reweight.py --loss-type ProxyNCA_pfix_confusion_178_threshold50_10epochs \
--helpful Influential_data/cars_ProxyNCA_pfix_helpful_testcls9_threshold50.npy \
--harmful Influential_data/cars_ProxyNCA_pfix_harmful_testcls9_threshold50.npy --model_dir models/dvi_data_cars_4_lossProxyNCA_pfix/ResNet_512_Model \
--helpful_weight 2 --harmful_weight 0 \
--dataset cars --seed 4 --config config/cars_reweight.json
