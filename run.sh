...
--helpful_weight 2 --harmful_weight 0
python train_sample_reweight.py --loss-type ProxyNCA_pfix_confusion_117_threshold50_40epochs \
...
--helpful_weight 2 --harmful_weight 0
python train_sample_reweight.py --loss-type ProxyNCA_pfix_confusion_172_threshold50_40epochs \
...
--helpful_weight 2 --harmful_weight 0
python train_sample_reweight.py --loss-type ProxyNCA_pfix_confusion_116_threshold50_40epochs \
...
--helpful_weight 2 --harmful_weight 0
python train_sample_reweight.py --loss-type ProxyNCA_pfix_confusion_196_threshold50_40epochs \
...
--helpful_weight 2 --harmful_weight 0
python train_sample_reweight.py --loss-type ProxyNCA_pfix_confusion_130_threshold50_40epochs \
