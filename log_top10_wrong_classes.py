...
if __name__ == '__main__':
    ...
    heatmap[:] = np.nan
    for it, cars_nca_seed in enumerate(inshop_nca):
    ...
    ax.set_ylabel('Proxy-NCA++', fontdict={'fontsize': 20})
    ax.set_yticks(range(5))
    ax.set_yticklabels(['Seed 0', 'Seed 1', 'Seed 2', 'Seed 3', 'Seed 4'])
    ax.set_xticks([])
    ...
    heatmap = np.empty((5, nb_classes))
    heatmap[:] = np.nan
    for it, cub_anchor_seed in enumerate(inshop_anchor):
    ...
    ax.set_ylabel('Proxy-Anchor', fontdict={'fontsize': 20})
    ax.set_yticks(range(5))
    ax.set_yticklabels(['Seed 0', 'Seed 1', 'Seed 2', 'Seed 3', 'Seed 4'])
    ax.set_xticks([])
    ...
    heatmap = np.empty((5, nb_classes))
    heatmap[:] = np.nan
    for it, cub_softtriple_seed in enumerate(inshop_softtriple):
    ...
    ax.set_ylabel('SoftTriple', fontdict={'fontsize': 20})
    ax.set_yticks(range(5))
    ax.set_yticklabels(['Seed 0', 'Seed 1', 'Seed 2', 'Seed 3', 'Seed 4'])
    ...
    plt.xlabel("Testing Classes", fontdict={'fontsize': 20})
    plt.show()
